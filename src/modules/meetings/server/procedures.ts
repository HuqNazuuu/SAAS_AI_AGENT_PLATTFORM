  ...
  create: premiumProcedure('meetings')
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      await call.getOrCreate({
        data: {
          created_by_id: ctx.auth.user.id, // this line making it that only admin can start the call
          custom: {
      ...
      // console.log('Created call:', call.id, call.type)
